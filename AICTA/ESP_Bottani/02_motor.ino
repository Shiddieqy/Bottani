enum Motor{L,R,X,Z,S};
int pwm[N_Motor] = {L_PWM,R_PWM,X_PWM,Z_PWM,S_PWM};
int forward[N_Motor] = {26,R_FORWARD,X_FORWARD,Z_FORWARD,S_FORWARD};
int m_reverse[N_Motor] = {27,R_REVERSE,X_REVERSE,Z_REVERSE,S_REVERSE};
int prev_cmd[N_Motor] = {0,0,0,0,0};
int increment = 3;
